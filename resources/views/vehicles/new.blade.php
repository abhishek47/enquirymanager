                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('vehicles.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('vehicle_cost') ? ' has-error' : '' }}">
                            <label for="vehicle_cost" class="control-label">Vehicle Cost</label>
                                ...
                                <input id="vehicle_cost" type="text" class="form-control" name="vehicle_cost" value="{{ old('vehicle_cost') }}" required autofocus>
                         ...
                         <div class="form-group{{ $errors->has('rto_charges') ? ' has-error' : '' }}">
                            <label for="rto_charges" class="control-label">R.T.O Charges</label>
                                ...
                                <input id="rto_charges" type="text" class="form-control" name="rto_charges" value="{{ old('rto_charges') }}" required autofocus>
                         ...
                         <div class="form-group{{ $errors->has('insuarance_charges') ? ' has-error' : '' }}">
                            <label for="insuarance_charges" class="control-label">Insuarance Charges</label>
                                ...
                                <input id="insuarance_charges" type="text" class="form-control" name="insuarance_charges" value="{{ old('insuarance_charges') }}" required autofocus>
